...
const AnimatedInput = React.forwardRef<HTMLInputElement, AnimatedInputProps>(({ className, type, ...props }, ref) => {
      ...
      <input
        ...
        className={cn(
          ...
          focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-neutral-400 disabled:cursor-not-allowed
           ...
           dark:bg-muted
           dark:text-white dark:shadow-[0px_0px_1px_1px_var(--neutral-700)] dark:focus-visible:ring-ring
           `,
          className,
        )}
        ref={ref}
